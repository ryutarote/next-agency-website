	...
	<Carousel className='bg-black text-white py-10 lg:py-20'>
		...
		<CarouselItem index={3}>
			<Review by='Slave (Shinees)'>
				“How to solve our issue with growing on the market was explained
				promptly and politely. Excellent service.”
			</Review>
		</CarouselItem>
		<CarouselItem index={4}>
			<Review by='Folister (Quest animals)'>
				“Burnavy's relentless pursuit of knowledge and touring in the busines
				has led to countless journey all across the globe.”
			</Review>
		</CarouselItem>
	</Carousel>
);
